...
CREATE TABLE `compra` (
  ...
  `fecha` datetime(6) NOT NULL,
  `num_factura_proveedor` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `metodo_pago` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `factura` (
  ...
  `estado_pago` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-03-12 19:11:10
