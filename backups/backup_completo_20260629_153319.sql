...
INSERT INTO `compatibilidad_producto` VALUES (1,3,1,1),(2,3,1,2);
...
INSERT INTO `detalle_orden_producto` VALUES (1,1,250000.00,2,1);
...
INSERT INTO `django_session` VALUES ('o00kf58oprffx6otatahlcf3uqw40bzd','.eJxVjLsOwjAMAP_FKzQyLnGajOxs7JHzgAZKKzUtC-LfERIDrHene4KXden9WvPsSwIHGra_LEi85fEj0lXGy6TiNC5zCeqTqK-t6jilPBy-7d-gl9qDA8aw31kdhdLZRrYxZDFMKCFEi91OGzRoWjKaOt1lOaeQjCEi7jKHlmEL67CUu_g5P0ot0-hlyPMiFRwQEjfIDdkToaPWESqNllu7QXSI8HoDcrZIhw:1weIVk:J0aAaW2EK9TDhw91S2XvRg01MlFxmyVWc5YGGM37iM0','2026-07-13 20:23:20.554474');
...
INSERT INTO `marca` VALUES (1,'Toyota','REPUESTO','Alemania','','Gama alta',1,'2026-06-21 21:27:26.978400'),(2,'Chevrolet','REPUESTO','Alemania','','',1,'2026-06-23 13:06:19.235796'),(3,'Bosh','AUTO','Arabia Saudita','','',0,'2026-06-23 13:23:06.612348');
...
INSERT INTO `notificacion` VALUES (5,'Urgente','SISTEMA','Mantenimiento prÃ³ximo â€” ABC123','Faltan 2 dÃ­as para el mantenimiento (fecha: 01/07/2026).',0,'2026-06-29',1);
...
INSERT INTO `orden_servicio` VALUES (1,'2026-06-29 20:02:06.697701',100000,'Terminado',NULL,6,1),(2,'2026-06-29 20:27:38.478597',200000,'En Proceso',NULL,6,1);
...
INSERT INTO `orden_servicio_detalle` VALUES (1,200000.00,1,2),(2,200000.00,2,2);
...
INSERT INTO `producto` VALUES (1,'Aceite','buen aceite',250000.00,4,1,'12345678987654','LT','',1,1);
...
INSERT INTO `seguimiento_mantenimiento` VALUES (1,100000,105000,'2026-07-01','Pendiente',0,'Creado automÃ¡ticamente desde Orden #1. Km al momento: 100,000. PrÃ³ximo cambio a los 105,000 km (5,000 km restantes). Uso del vehÃ­culo: Uso bajo (ciudad, poco uso) (~30 km/dÃ­a, cambio cada 5,000 km). Estimado: 166 dÃ­as.','2026-06-29 20:02:06.725589','2026-06-29 20:02:06.725634',1,2,1),(2,200000,205000,'2026-12-12','Pendiente',1,'Creado automÃ¡ticamente desde Orden #2. Km al momento: 200,000. PrÃ³ximo cambio a los 205,000 km (5,000 km restantes). Uso del vehÃ­culo: Uso bajo (ciudad, poco uso) (~30 km/dÃ­a, cambio cada 5,000 km). Estimado: 166 dÃ­as.','2026-06-29 20:27:38.533462','2026-06-29 20:27:38.533489',2,2,1);
...
INSERT INTO `tipo_servicio` VALUES (1,'cambio aceite','',80000.00,1,0,0,'2026-06-23 14:56:09.370946','2026-06-23 14:56:09.370969'),(2,'Aceite','',200000.00,1,1,1,'2026-06-29 19:59:13.807190','2026-06-29 20:26:48.629979');
...
INSERT INTO `vehiculo` VALUES (1,'ABC123','2006','BAJO','2026-06-29 19:55:21.761912','2026-06-29 19:55:21.761945',1,3);
...
-- Dump completed on 2026-06-29 15:33:20
